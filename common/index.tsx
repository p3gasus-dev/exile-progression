...
/**
 * League mechanic — visually distinct from generic steps so players can
 * quickly identify optional or important mechanic interactions in the route.
 * Triggered in route files with: {league|Legion Encounter}
 */
function LeagueMechanicComponent(text: string) {
  return <span className={classNames(styles.leagueMechanic)}>{text}</span>;
}
...
export function Fragment(
  ...
  switch (fragment.type) {
    ...
    case "league":
      return [LeagueMechanicComponent(fragment.value), null];
    case "reward_quest":
