...
export const CHALLENGES: Challenge[] = [
  ...
  },
  {
    ...
    steps: [
      "The Way Forward (Act 2)",
      "Through Sacred Ground (Act 2)",
      "Victario's Secrets (Act 3)",
      "An Indomitable Spirit (Act 4)",
    ],
    category: "campaign",
    difficulty: "very-easy",
    stepHints: {
  ...
  },
  {
    ...
    steps: [
      ...
      "Defeat Lunaris, Eternal Moon and Solaris, Eternal Sun (Act 8)",
  ...
  },
  {
    ...
    stepHints: {
      ...
      4: [
        ...
        "Very simple to search for on the trade website, simply look for area level of 81 and set the heist section to include four revealed wings",
      ...
      7: [
        ...
        "Build multiple damage types in each lane to cover immunities",
      ...
      8: [
        ...
        "This is a fairly big undertaking — you cannot fill vessels from rituals that used vessels",
      ],
      9: [
        "Basic Kingsmarch interaction, map runners are purely a gold sink, you want highest level possible",
        "It is rare maps only so you can transmute and regal maps for highest clear chances",
      ],
      10: ["Stack unstable breaches, disable hives and run the `Breach Scarab of the Marshal` — can do this in two to three maps"],
    },
    tips: [
      "A copy of last league's. If you don't run Heist they are a very obvious skip and Kingsmarch is much more RNG reliant than the others making that a good second option for skipping.",
    ],
  },
  {
    ...
    questType: "new-content",
    steps: [
      "Complete Abysses in Mirages (0/15)",
      "Complete Expeditions in Mirages (0/15)",
      "Complete Harvest Plots in Mirages (0/50)",
      "Complete Legion Encounters in Mirages (0/15)",
      "Open Smuggler's Caches in Mirages (0/15)",
      "Pass through Mirrors of Delirium in Mirages (0/15)",
      "Complete Ultimatum Waves in Mirages (0/50)",
      "Complete Blights in Mirages (0/15)",
      "Complete Rituals in Mirages (0/25)",
      "Complete Ore Deposit Encounters in Mirages (0/15)",
      "Complete Unstable Breaches or Hives in Mirages (0/15)",
    ],
    requires: 4,
    category: "mechanics",
    difficulty: "medium",
  ...
  },
  {
    ...
    stepHints: {
      0: [
        ...
        "There is a PoeWiki listing for all of these which includes other options",
      ],
  ...
  },
  {
    ...
    tips: [
      "This is the new content. It's only 7 of 11 at least. The prices of the Coins has gone up because they are not actually super common, they might come back down as the league progresses.",
    ],
  },
  {
    ...
    steps: [
      ...
      "Complete Caer Blaidd, Wolfpack's Den",
    ...
    tips: [
      "This is all the maps and there's no more scouting reports. Unique Maps need you to be able to see them on the Atlas to open them even if you have the map item.",
  ...
  },
  {
    ...
    steps: [
      "Cartography Scarab (0/30)",
      "Divination Scarab (0/30)",
      "Titanic Scarab (0/30)",
      "Bestiary Scarab (0/30)",
      "Betrayal Scarab (0/30)",
      "Delve Scarab (0/30)",
      "Incursion Scarab (0/30)",
      "Anarchy Scarab (0/30)",
      "Domination Scarab (0/30)",
      "Essence Scarab (0/30)",
      "Strongbox Scarab (0/30)",
      "Torment Scarab (0/30)",
      "Influence Scarab (0/30)",
      "Abyss Scarab (0/30)",
      "Beyond Scarab (0/30)",
      "Blight Scarab (0/30)",
      "Breach Scarab (0/30)",
      "Delirium Scarab (0/30)",
      "Expedition Scarab (0/30)",
      "Harvest Scarab (0/30)",
      "Kalguuran Scarab (0/30)",
      "Legion Scarab (0/30)",
      "Ritual Scarab (0/30)",
      "Ultimatum Scarab (0/30)",
      "Misc Scarab (0/30)",
      "Horned Scarab (0/30)",
    ],
    requires: 8,
    ...
    difficulty: "medium",
    tips: [
      "Assuming maximum slots, you can gain 5 progress towards this per map ran. This ends up around 48 maps baseline if you are not wasting any — you can reasonably get it passively if you run multiple mechanics across the league.",
    ],
  },
  {
    ...
    stepHints: {
      ...
      2: [
        "This is across every gear piece — you can reach the 300% without links",
        ...
        "`Ashes of the Stars` is +20-30% quality for all gems which will instantly finish the challenge if you have at least 10 gems socketed",
      ],
  ...
  },
  {
    ...
    stepHints: {
      ...
      2: [
        "`Essence Scarab of Calcification` paired with `Torment Scarab of Possession` makes this straightforward",
      ...
      4: [
        "Luck based, stacking beyond and delirium at the same time probably gets the best hopes",
        "You can use a Delirium Orb to force delirium for the entire map",
        "`Delirium Scarab of Neuroses` forces boss spawns, you can spam them in maps with 100% harvest chance and rush to the grove",
      ],
      5: [
  ...
  },
  {
    ...
    stepHints: {
      ...
      4: [
        ...
        "The deeper you are the higher your chances; you can presumably buy a taxi for this",
      ],
      5: [
        ...
        "Logbooks can force bosses, you should get one of those if you aren't farming expedition",
      ],
      6: [
        "For the `Lycia Bloodline`, defeat `Lycia, Herald of the Scourge` in the `Forbidden Sanctum`",
        "This is just completing a `Forbidden Tome`, doesn't seem to have an area level requirement",
      ],
      7: ["For the `Farrul Bloodline`, defeat `Farrul, First of the Plains` in the Menagerie by using a `Farric Tiger Alpha`"],
      8: [
    ...
    tips: [
      "Engage with the recent bloodlines mechanic. You can buy carries for this but most of the bosses aren't too bad. Simulacrum and Lycia are obvious skip choices as they are very specific content with specific build requirements.",
    ],
  },
  {
    id: "atlas-astrolabes",
    ...
    difficulty: "medium",
    tips: [
      "Astrolabes drop from Memory Chain bosses and everywhere on the Atlas after completing Zana's three memory chains.",
      "This is simply completing Tier 14 or higher maps — comes out at 120 maps total.",
      "Astrolabe drop rates are nowhere close to being accessible right now so be prepared to currency dump.",
  ...
  },
  {
    ...
    steps: [
      "Defeat Witnessed Map Bosses in Astrolabe-affected Maps (0/100)",
      "Activate Eldritch Altars in Astrolabe-affected Maps (0/200)",
    ],
    requires: 1,
    category: "atlas",
    difficulty: "medium",
  ...
  },
  {
    ...
    difficulty: "medium",
    tips: [
      "This looks like at minimum 25 full sets of astrolabe maps — this might end up rather grind heavy.",
  ...
  },
  {
    ...
    steps: [
      "Complete Screaming Invitation (4+ mods)",
      "Complete Incandescent Invitation (4+ mods)",
      "Complete The Elderslayers (4+ mods)",
      "Complete The Feared (4+ mods)",
      "Complete The Forgotten (4+ mods)",
      "Complete The Formed (4+ mods)",
      "Complete The Remembered (4+ mods)",
      "Complete The Twisted (4+ mods)",
    ],
    category: "boss",
    difficulty: "medium",
    stepHints: {
      ...
      3: [
        ...
        "Incarnation of Dread (`Echo of Reverence` boss)",
        "GGG did not deploy itemised memories, so it is still dreadful",
      ],
      4: [
        ...
        "Very good gold returns for time investment, decent chance of `Cortex` and very low chance of jackpot rings",
      ],
      5: [
      ...
      7: [
        ...
        "Selling the fragments generally covers the cost of the maps",
      ],
    },
    tips: [
...

  {
    ...
    tips: [
      ...
      "The `Scarab of Bisection` has been retired — there's now the `Scarab of the Sinistral` and `Scarab of the Dextral` which disable Suffixes and buffs Prefixes (or vice versa).",
    ],
  },
  {
  ...
  },
  {
    ...
    questType: "new-content",
    steps: [
      "Slay the Map Bosses of 75 Tier 16 Maps affected by an Atlas Astrolabe while they are Rare with at least 150% Item Quantity",
    ],
    category: "atlas",
    difficulty: "hard",
    tips: [
      "Astrolabes are disgustingly scarce compared to what was expected — you will average maybe one per two hundred maps. You are likely to spend several divines finishing this up with current prices. Considering the requirement is also a pretty juiced map, this might end up rough.",
    ],
  },
  {
    id: "uber-undertaking",
    ...
    difficulty: "hard",
    tips: [
      "This is five of the ten uber boss variants — if you have a boss killer this should be fine, otherwise you can buy the clears.",
      "Shaper and Cortex are the most reasonable to self-complete. All of the fights have lingering damage over time that lasts the entire fight which makes high DPS crucial.",
    ],
  },
  {
    ...
    stepHints: {
      0: [
        ...
        "Coward's Trial",
        "`Omen of Amelioration` stops you losing all your XP on dying, but only once per area — do not take one into an invitation or uber boss, you will still lose your Omen despite no XP loss being possible",
      ...
      2: [
        "It's 1,000 maps using scarabs. T16.5s are still T16s",
      ],
      ...
      5: ["Not sure how hard this will end up, but you can presumably run fully miraged maps to force this."],
    },
    tips: [
