...
export const CHALLENGES: Challenge[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "Defeat Izaro with a Harvest Offering (level 80+)",
      "Defeat an Abyssal Lich (level 80+)",
      "Defeat the Omnitect — Chronicle of Atzoatl (level 80+)",
  ...
  },
  {
    ...
    steps: [
      ...
      "Crystallised Rancour Craft (0/3)",
  ...
  },
  {
    ...
    steps: [
      "Cartography Scarab (0/30) in T14+ Rare Maps",
      "Divination Scarab (0/30) in T14+ Rare Maps",
      "Titanic Scarab (0/30) in T14+ Rare Maps",
      "Bestiary Scarab (0/30) in T14+ Rare Maps",
      "Betrayal Scarab (0/30) in T14+ Rare Maps",
      "Delve Scarab (0/30) in T14+ Rare Maps",
      "Incursion Scarab (0/30) in T14+ Rare Maps",
      "Anarchy Scarab (0/30) in T14+ Rare Maps",
      "Domination Scarab (0/30) in T14+ Rare Maps",
      "Essence Scarab (0/30) in T14+ Rare Maps",
      "Strongbox Scarab (0/30) in T14+ Rare Maps",
      "Torment Scarab (0/30) in T14+ Rare Maps",
      "Influence Scarab (0/30) in T14+ Rare Maps",
      "Abyss Scarab (0/30) in T14+ Rare Maps",
      "Beyond Scarab (0/30) in T14+ Rare Maps",
      "Blight Scarab (0/30) in T14+ Rare Maps",
      "Breach Scarab (0/30) in T14+ Rare Maps",
      "Delirium Scarab (0/30) in T14+ Rare Maps",
      "Expedition Scarab (0/30) in T14+ Rare Maps",
      "Harvest Scarab (0/30) in T14+ Rare Maps",
      "Kalguuran Scarab (0/30) in T14+ Rare Maps",
      "Legion Scarab (0/30) in T14+ Rare Maps",
      "Ritual Scarab (0/30) in T14+ Rare Maps",
      "Ultimatum Scarab (0/30) in T14+ Rare Maps",
      "Misc Scarab (0/30) in T14+ Rare Maps",
      "Horned Scarab (0/30) in T14+ Rare Maps",
    ],
    requires: 8,
    category: "atlas",
    difficulty: "medium",
  ...
  },
  {
    ...
    steps: [
      "Defeat Trialmaster (lv81+ Ultimatum)",
      "Defeat King in the Mists (Audience With The King)",
      "Defeat Oshabi (Sacred Blossom)",
      "Defeat Catarina (Syndicate Medallion)",
      "Defeat Aul (Delve depth 130+)",
      "Defeat Olroth (Knights of the Sun Logbook lv81+)",
      "Defeat Lycia (Forbidden Sanctum)",
      "Defeat Farrul (Menagerie)",
      "Complete Simulacrum (all 15 waves)",
      "Defeat It That Was Tul and Esh (Breach Fortress)",
      "Defeat Saresh of the Weeping Black",
    ],
    requires: 7,
    category: "boss",
    difficulty: "medium",
  ...
  },
  {
    ...
    steps: [
      "Templar region — 30x T14+ Rare Maps",
      "Fruiting region — 30x T14+ Rare Maps",
      "Lightless region — 30x T14+ Rare Maps",
      "Grasping region — 30x T14+ Rare Maps",
      "Nameless region — 30x T14+ Rare Maps",
      "Fungal region — 30x T14+ Rare Maps",
      "Chaotic region — 30x T14+ Rare Maps",
      "Enshrouded region — 30x T14+ Rare Maps",
      "Timeless region — 30x T14+ Rare Maps",
      "Runic region — 30x T14+ Rare Maps",
      "Prospecting region — 30x T14+ Rare Maps",
    ],
    requires: 4,
    category: "atlas",
    difficulty: "medium",
  ...
  },
  {
    ...
    steps: [
      "Screaming Invitation (Eater of Worlds) with 4+ modifiers",
      "Incandescent Invitation (Searing Exarch) with 4+ modifiers",
      "The Elderslayers (4 Conquerors) with 4+ modifiers",
      "The Feared (Shaper/Elder/Cortex/Sirus/Dread) with 4+ modifiers",
      "The Forgotten (4 Distant Memories) with 4+ modifiers",
      "The Formed (4 Shaper Guardian Maps) with 4+ modifiers",
      "The Remembered (3 penultimate memory bosses) with 4+ modifiers",
      "The Twisted (4 Elder Guardian Maps) with 4+ modifiers",
    ],
    category: "boss",
    difficulty: "hard",
    tips: [
...

  {
    ...
    steps: [
      "Abomination (T17 Map, 175%+ IIQ)",
      "Citadel (T17 Map, 175%+ IIQ)",
      "Fortress (T17 Map, 175%+ IIQ)",
      "Sanctuary (T17 Map, 175%+ IIQ)",
      "Ziggurat (T17 Map, 175%+ IIQ)",
    ],
    requires: 4,
    category: "atlas",
    difficulty: "medium",
