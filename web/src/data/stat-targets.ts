...
export const BOSS_STEP_HINTS: Record<string, StatTarget[]> = {
  ...
  "Brutus, Lord Incarcerator": [
    ...
    { label: "Lightning",    value: "~200",   note: "Lightning chain" },
    { label: "Lightning Res", value: "75%" },
  ],
  "Captain Fairgraves": [
    { label: "Level",    value: "11" },
    { label: "DPS",      value: "~150",   note: "~9k HP / 60s" },
    { label: "Lightning",    value: "~200",   note: "Lightning bolts" },
  ...
  "Vaal Oversoul": [
    ...
    { label: "Lightning",    value: "~500",   note: "Lightning bolt" },
    { label: "Lightning Res", value: "75%" },
  ...
  "Shavronne the Returned": [
    ...
    { label: "DPS",      value: "~3.3k",  note: "~200k HP / 60s" },
    { label: "Lightning",    value: "~600",   note: "Lightning bolts" },
  ...
  "Maligaro, the Artist": [
    ...
    { label: "DPS",      value: "~5k",    note: "~300k HP / 60s" },
    { label: "Lightning",    value: "~700",   note: "Lightning slam" },
  ...
  "Greust, Lord of the Forest": [
    ...
    { label: "DPS",      value: "~3.3k",  note: "~200k HP / 60s" },
    { label: "Phys",     value: "~700",   note: "Slam" },
    { label: "Lightning",    value: "~500",   note: "Lightning strike" },
    { label: "Lightning Res", value: "75%" },
  ],
  ...
  "Arakaali, Spinner of Shadows": [
    ...
    { label: "Lightning",    value: "~800",   note: "Lightning strike" },
    { label: "Chaos Res", value: "≥ 0%",  warn: true },
  ...
  "Doedre the Vile": [
    ...
    { label: "DPS",      value: "~5k",    note: "~300k HP / 60s" },
    { label: "Chaos",    value: "~700",   warn: true, note: "Chaos DoT" },
    { label: "Lightning",    value: "~500",   note: "Lightning beam" },
    { label: "Chaos Res", value: "≥ 0%",  warn: true },
  ...
  "Yugul, Reflection of Terror": [
    ...
    { label: "Lightning",    value: "~600",   note: "Lightning strike" },
    { label: "Cold Res", value: "75%",    warn: true },
    { label: "Freeze",   value: "Immune", note: "Cold attacks can Freeze" },
  ],
  ...
  "Garukhan, Queen of the Winds": [
    ...
    { label: "DPS",      value: "~20k",   note: "~1.2M HP / 60s" },
    { label: "Lightning",    value: "~1k",    warn: true, note: "Lightning slam" },
    { label: "Phys",     value: "~700",   note: "Slam" },
    { label: "Lightning Res", value: "75%",   warn: true },
  ],
  "Doedre, Darksoul": [
  ...
  "Maligaro, The Broken": [
    ...
    { label: "Lightning",    value: "~700",   note: "Lightning" },
    { label: "Lightning Res", value: "75%" },
  ...
  "The Depraved Trinity": [
    ...
    { label: "Lightning",    value: "~1.2k",  note: "Lightning phase" },
    { label: "Fire Res", value: "75%",    warn: true },
    { label: "Cold Res", value: "75%",    warn: true },
    { label: "Lightning Res", value: "75%",   warn: true },
  ],
  ...
  "Plaguewing": [
    ...
    { label: "DPS",      value: "~1.7k",  note: "~100k HP / 60s" },
    { label: "Lightning",    value: "~600",   note: "Lightning beam" },
  ...
  "Avarius, Reassembled": [
    ...
    { label: "Lightning",    value: "~700",   note: "Holy beam" },
    { label: "Lightning Res", value: "75%" },
  ...
  "The Shaper Guardian (Minotaur)": [
    ...
    { label: "Lightning",    value: "~3k",    note: "Lightning strike" },
  ...
  "The Elder Guardian (Eradicator)": [
    { label: "Level",    value: "80" },
    { label: "DPS",      value: "~580k",  warn: true, note: "~35M HP / 60s" },
    { label: "Lightning",    value: "~4k",    warn: true, note: "Lightning beam" },
